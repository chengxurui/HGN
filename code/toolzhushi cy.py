...
input_data.v_net_embed, input_data.v_text_embed]
    ...
    def node_het_agg(self, id_batch, node_type):  # 异构的邻居
        ...
        print('site3a:', site3_agg_batch_2)
        ...
        concate_embed = torch.cat((c_agg_batch_2, s_agg_batch_2, ag11_agg_batch_2, ag14_agg_batch_2,ag16_agg_batch_2, ag20_agg_batch_2, ag58_agg_batch_2,
                                   site1_agg_batch_2, site2_agg_batch_2, site3_agg_batch_2, site4_agg_batch_2, sex1_agg_batch_2, sex2_agg_batch_2), 1).view(len(c_agg_batch), 13, self.embed_d * 2)
        # print('en:', concate_embed.shape)  [200, 13, 3900]
        if node_type == 1:
        ...
        atten_w = self.softmax(atten_w).view(len(c_agg_batch), 1, 13)  # softmax torch.Size([200, 1, 13])  (batch_size, n, m)
       ...
       ###############################################################
        ...
        data = pd.read_csv('D:/codee/data/abide/Phenotypic_V1_0b_preprocessed1--.csv')
        id_batch_ = id_batch.tolist()
        id_batch_ = [item for sublist in id_batch_ for item in sublist]
        ...
        concate_embed = torch.cat((c_agg_batch, s_agg_batch, ag11_agg_batch, ag14_agg_batch, ag16_agg_batch,ag20_agg_batch, ag58_agg_batch,
                                   site1_agg_batch, site2_agg_batch, site3_agg_batch, site4_agg_batch, sex1_agg_batch, sex2_agg_batch), 1).view(len(c_agg_batch), 13, self.embed_d)  # [200,13,1950]
    ...
    def het_agg(self, triple_index, c_id_batch, pos_id_batch, neg_id_batch):
        ...
        if triple_index == 0:
            ...
            embed_file = open(self.args.data_path1 + "node_embedding.txt", "w")
